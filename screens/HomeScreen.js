...
var items = [
  ...
  {id: 7, place: 'Budapest', country: 'Hungary'},
  {id: 2, place: 'London Eye', country: 'England'},
  {id: 3, place: 'Washington dc', country: 'America'},
  {id: 4, place: 'New york', country: 'America'},
  {id: 5, place: 'Los Ang', country: 'America'},
  {id: 6, place: 'Washington DC', country: 'America'},
  {id: 8, place: 'Lahore', country: 'Pakistan'},
];
    ...
    <ScreenWrapper className="flex-1">
      ...
      <View className="px-4 space-y-3">
        <View className="flex-row justify-between items-center mb-4">
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('AddTrip')} className="p-2 px-3 bg-white border border-gray-700 rounded-full">
